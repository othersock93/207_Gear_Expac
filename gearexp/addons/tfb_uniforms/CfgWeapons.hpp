...
class tfb_g3_mc_g_w: tfb_g3_base_w
{
	...
	scopeArsenal = 2;
	author="207 Community Author";
	displayName = "Crye G3, Full [G/P] (AMC)";
	picture = "\tfb_uniforms\ui\g3_mc_ca.paa";
...
class tfb_g3_mc_r1_g_w: tfb_g3_base_w
{
	scope = 2;
	scopeArsenal = 2;
	displayName = "Crye G3, 1/4 Roll [G/P] (AMC)";
	picture = "\tfb_uniforms\ui\g3_mc_ca.paa";
	class ItemInfo: ItemInfo
	{
...
class tfb_g3_mc_r2_g_w: tfb_g3_base_w
{
	scope = 2;
	scopeArsenal = 2;
	displayName = "Crye G3, 1/2 Roll [G/P] (AMC)";
...
class tfb_g3_mc_w: tfb_g3_base_w
{
	scope = 2;
	scopeArsenal = 2;
	displayName = "Crye G3, Full [P] (AMC)";
	picture = "\tfb_uniforms\ui\g3_mc_ca.paa";
	class ItemInfo: ItemInfo
	{
...
class tfb_g3_mc_r1_w: tfb_g3_base_w
{
	scope = 2;
	scopeArsenal = 2;
	displayName = "Crye G3, 1/4 Roll [P] (AMC)";
	picture = "\tfb_uniforms\ui\g3_mc_ca.paa";
	class ItemInfo: ItemInfo
	{
...
class tfb_g3_mc_r2_w: tfb_g3_base_w
{
	scope = 2;
	scopeArsenal = 2;
	displayName = "Crye G3, 1/2 Roll [P] (AMC)";
	picture = "\tfb_uniforms\ui\uni1_ca.paa";
	class ItemInfo: ItemInfo
	{
