...
class CfgGlasses
{
	...
	class skull_bala_b1: adfrc_facewear_Balaclava_blk_1
	{
		...
		hiddenSelectionsTextures[] = {"skull_mask\tx\skull_b_co.paa"};
	};
	class skull_bala_o1: adfrc_facewear_Balaclava_blk_1
	{
		...
		hiddenSelectionsTextures[] = {"skull_mask\tx\skull_o_co.paa"};
	};
	class skull_bala_t1: adfrc_facewear_Balaclava_blk_1
	{
		...
		hiddenSelectionsTextures[] = {"skull_mask\tx\skull_t_co.paa"};
	};
